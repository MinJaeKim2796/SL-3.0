...
for i in range(len(player)):
    bb.append(player[i][7])
    homerun.append(player[i][6])
    name.append(str(player[i][0]))


plt.scatter(bb, name, marker = '.', color = 'red', label = 'bb')
plt.scatter(homerun, name, marker = '+', color = 'blue', label = 'homerun')
plt.xlabel('# of BB & Homerun')
plt.ylabel('Player name')
plt.legend(loc = 9)
plt.title('BB & Homerun Correlation')
plt.show()
